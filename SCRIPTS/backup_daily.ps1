...
Compress-Archive -Path "C:\Users\omer\Desktop\backup\spice_direct" -DestinationPath "C:\Users\omer\Desktop\backup\backup_mongo_daily.zip" -Force

Copy-Item "C:\Users\omer\Desktop\backup\backup_mongo_daily.zip" -Destination "G:\My Drive" -Force
